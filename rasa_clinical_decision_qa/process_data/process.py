...
def extract_drug_producer():
    ...
    with open(os.path.join(common_path, './drugs.csv'), 'r', encoding='utf-8') as f1:
        data1 = f1.readlines()
        for line in data1:
            line = line.strip()
            line = line.split(',')
    ...
    with open(os.path.join(common_path, './producers.csv'), 'r', encoding='utf-8') as f2:
        data2 = f2.readlines()
        for line in data2:
            line = line.strip()
            line = line.split(',')
    ...
    with open(os.path.join(common_path, './rels_drug_producer.csv'), 'r', encoding='utf-8') as f3:
        data3 = f3.readlines()
        for line in data3:
            line = line.strip()
            line = line.split(',')
...
if __name__ == '__main__':
    ...
    diseases_dict = process_data([os.path.join(common_path, 'medical.json')])
