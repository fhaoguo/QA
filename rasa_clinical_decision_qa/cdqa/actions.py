...
medical_lookup_path = '../../dat/medical/lookup'
disease_file = os.path.join(medical_lookup_path, 'Diseases.txt')
disease_names = \
    [i.strip() for i in open(disease_file, 'r', encoding='UTF-8').readlines()]
...
class ActionFirst(Action):
    ...
    def run(self,
        ...
        dispatcher.utter_message(md("您可以这样向我提问: <br/>"
                                    "头痛怎么办<br/>\
                                    什么人容易头痛<br/>\
                                    头痛吃什么药<br/>\
                                    头痛能治吗<br/>\
